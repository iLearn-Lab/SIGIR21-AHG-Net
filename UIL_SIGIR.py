...
from load_data_new import load_content, load_tl, load_img
...
def load_user(path_dir):
    ...
    user_path = path_dir + 'train_name_shuffle.csv'
    label_path = path_dir + 'train_label_shuffle.csv'
...
def index_dict(index, index_dict_tw, index_dict_fq):
    ...
    for pair in index:
        ...
        # fq3.extend([index_dict_fq[pair[3]]])
    return tw1, fq1, fq2
...
path_dir = './dataset/new_dataset2_shuffle_2/'

path_index_tw = '/home/share/chenxiaolin/UIL2/Model/dataset/Network/user_index_tw.npy'
path_index_fq = '/home/share/chenxiaolin/UIL2/Model/dataset/Network/user_index_fq.npy'
...
num_epochs = 2000 # 200 1000 2000
batch_size = 16 #64 32

num_filters = 1024 #2--128--256---512---1024
...
path_biases_tw = '/home/share/chenxiaolin/UIL2/Model/dataset/Network/tw_bias_matrix.npy'
path_biases_fq = '/home/share/chenxiaolin/UIL2/Model/dataset/Network/fq_bias_matrix.npy'
biases_tw = np.load(path_biases_tw)
biases_fq = np.load(path_biases_fq)


path_embedding_tw = '/home/share/chenxiaolin/UIL2/Model/dataset/Network/tw_sort.npy'
path_embedding_fq = '/home/share/chenxiaolin/UIL2/Model/dataset/Network/fq_sort.npy'
    ...
    with tf.Session(config=config) as sess:
        ...
        for epoch in range(num_epochs):
            ...
            for i in range(0, len(train_user), batch_size):   
                ...
                # discriminator
                loss, _, _, pre, loss_bpr1, loss_norm, domain_class_loss, TW1_con_rep1, coefs_TW = sess.run([model.cost_both, model.emb_train_op, model.domain_train_op, model.pre, model.loss_bpr1, model.loss_norm, model.domain_class_loss, model.TW1_con_rep1, model.coefs_TW], feed_dict={ model.x_batch_TW1:x_batch_TW1, model.x_batch_FQ1:x_batch_FQ1, model.x_batch_FQ2:x_batch_FQ2, model.x_batch_TW1_img:x_img_TW1, model.x_batch_FQ1_img: x_img_FQ1, model.x_batch_FQ2_img: x_img_FQ2,
                model.index_tw1:tw1, model.index_fq1:fq1, model.index_fq2: fq2, model.batch_size:len(x_index_batch), model.y_label:y_index_batch, model.y_label_pre: y_index_re_batch, model.training:True, model.keep_prob: 0.5, model.x_batch_TW_single:x_tw_single_batch, model.x_batch_FQ_single:x_fq_single_batch, model.x_batch_TW1_tl:x_tl_TW1, model.x_batch_FQ1_tl:x_tl_FQ1, model.x_batch_FQ2_tl:x_tl_FQ2, model.l:l})
            ...
            f_train1_auc = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/auc_%s_train_5_3_5.txt' % (str(lamda)),'a')
            f_train1_auc.write(str(auc_score_train)+'\n')
            f_train1_auc.close()  

            f_train1_precision = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/precision_%s_train_5_3_5.txt' % (str(lamda)),'a')
            f_train1_precision.write(str(precision_train)+'\n')
            f_train1_precision.close()     

            f_train1_recall = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/recall_%s_train_5_3_5.txt' % (str(lamda)),'a')
            f_train1_recall.write(str(recall_train)+'\n')
            f_train1_recall.close()        

            f_train1_f1 = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/f1_%s_train_5_3_5.txt' % (str(lamda)),'a')
            f_train1_f1.write(str(f1_train)+'\n')
            f_train1_f1.close()                

            f_train1_accuracy = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/accuracy_%s_train_5_3_5.txt' % (str(lamda)),'a')
            ...
            for j in range(0, len(test_user), batch_size):  
                ...
                loss_test, pre_test = sess.run([model.cost_both, model.pre], feed_dict={ model.x_batch_TW1:x_batch_TW1_test, model.x_batch_FQ1:x_batch_FQ1_test, model.x_batch_FQ2:x_batch_FQ2_test, model.index_tw1:tw1_test, model.index_fq1:fq1_test, model.index_fq2: fq2_test, model.batch_size:len(x_index_batch_test), model.y_label:y_index_batch_test, model.y_label_pre: y_index_re_batch_test, model.training:False, model.keep_prob: 1, model.x_batch_TW1_img:x_img_TW1_test, model.x_batch_FQ1_img: x_img_FQ1_test, model.x_batch_FQ2_img: x_img_FQ2_test,  model.x_batch_TW_single:x_tw_single_batch_test, model.x_batch_FQ_single:x_fq_single_batch_test, model.x_batch_TW1_tl:x_tl_TW1_test, model.x_batch_FQ1_tl:x_tl_FQ1_test, model.x_batch_FQ2_tl:x_tl_FQ2_test})  
            ...
            f_test_auc = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/auc_%s_validate_5_3_5.txt' % (str(lamda)),'a')
            f_test_auc.write(str(auc_score_test_epoch)+'\n')
            f_test_auc.close()  

            f_test_precision = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/precision_%s_validate_5_3_5.txt' % (str(lamda)),'a')
            f_test_precision.write(str(precision_test_epoch)+'\n')
            f_test_precision.close()     

            f_test_recall = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/recall_%s_validate_5_3_5.txt' % (str(lamda)),'a')
            f_test_recall.write(str(recall_test_epoch)+'\n')
            f_test_recall.close()        

            f_test_f1 = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/f1_%s_validate_5_3_5.txt' % (str(lamda)),'a')
            f_test_f1.write(str(f1_test_epoch)+'\n')
            f_test_f1.close()                

            f_test_accuracy = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/accuracy_%s_validate_5_3_5.txt' % (str(lamda)),'a')
            ...
            f_test_auc = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/auc_%s_test_5_3_5.txt' % (str(lamda)),'a')
            f_test_auc.write(str(auc_score_test_epoch2)+'\n')
            f_test_auc.close()  

            f_test_precision = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/precision_%s_test_5_3_5.txt' % (str(lamda)),'a')
            f_test_precision.write(str(precision_test_epoch2)+'\n')
            f_test_precision.close()     

            f_test_recall = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/recall_%s_test_5_3_5.txt' % (str(lamda)),'a')
            f_test_recall.write(str(recall_test_epoch2)+'\n')
            f_test_recall.close()        

            f_test_f1 = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/f1_%s_test_5_3_5.txt' % (str(lamda)),'a')
            f_test_f1.write(str(f1_test_epoch2)+'\n')
            f_test_f1.close()                

            f_test_accuracy = open('./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Record/accuracy_%s_test_5_3_5.txt' % (str(lamda)),'a')
        ...
        with open("./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Final/validate_final_result_%s_5_3_5.txt" % str(lamda), 'a') as ff1:
            ff1.write('lamda: %s\n' % (str(lamda)))
        ...
        with open("./result_adjust/UIL2_5/5_3_5_5_5_att_2_check_4_6_109_109_2_update_2/Final/test_final_result_%s_5_3_5.txt" % str(lamda), 'a') as ff1:
            ff1.write('lamda: %s\n' % (str(lamda)))
